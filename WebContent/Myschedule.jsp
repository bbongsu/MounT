<%@page import="Myinfo.MyscheduleDAO"%>
<%@page import="Myinfo.iMyscheduleDAO"%>
<%@page import="register.registerDTO"%>
<%@page import="java.util.Calendar"%>
<%@page import="Myinfo.MyscheduleDTO"%>
...
//각 날짜별로 테이블을 생성하는 함수
public String makeTable(int year, int month, int day, List<MyscheduleDTO> list)
{
	String s = "";
...
registerDTO user = (registerDTO)session.getAttribute("login");

iMyscheduleDAO dao = MyscheduleDAO.getInstance();
List<MyscheduleDTO> list 
	= dao.getscheduleList(user.getId(), year + two(month + ""));
%>
